  ...
  <body>\
    <div id='Contenedor'>\
      ...
      <div id='Cuerpo'>\
        ...
        <br>\
        <p>&nbsp;&nbsp; Sólo por esta vez (o si cambias de WiFi) debes conectarte a la red WiFi de tu casa</p>\
        <p>&nbsp;&nbsp; Si introduces erróneamente la red WiFi o contraseña, luego de veinte segundos puedes recargar esta misma página y volver a intentarlo. </p>\
        <div id='Contenedor2'>\
...
\
  ...
  pamandarhome += "\
      ...
      <div id='Expl2'>\
              <p>&nbsp;Proyecto de una materia de 6to año del instituto politécnico\
