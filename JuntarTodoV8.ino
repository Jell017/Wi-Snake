...
//Cada vez que le das al autoformato, las funciones server.on y server.send agregan espacios donde no deben ir. sacarlos para que funcione bien
  ...
  if (contador == 0) {
    ...
    $(document).ready(function() {
      ...
      /*
        ...
        //pamandargame += "<script type = 'text/javascript'> function actualizar() {
        location.reload(true);
        } setInterval('actualizar()', 390); < / script > ";
      */
    ...
    $(document).ready(function() {\
      ...
      */
      ...
      /*
        ...
        $('#Contenedor2').html('";
                               ...
                               pamandargame += "')
        } window.setInterval('actualizar()', 401); < / script > ";
      */
      ...
      */
      ...
      //pamandargame+="<script type = 'text/javascript'>function render () {\
      $('#Contenedor2').html('algo')\
    } window.setInterval(render, 401); < / script > ";
