...
void nuevo_juego() {//---------------------------------------------Al inicar o perder el juego se reinician algunos valores. Podría incluirse en otras funciones pero, como dijo Nietzsche: "Si funciona, no toqués más".
...
void PrintMapa() {//-----------------------------------------------Muestra el juego en el monitor serial.
  for (int z = 0; z < y ; z++) {
    for (int i = 0; i < x ; i++) {
...
void sensor() {//--------------------------------------------------Direcciona la serpiente, de acuerdo con el método elegido. 
