/* Cosas por hacer:  que al poner un mismo nombre y jugar dos veces, obteniendo dos valores diferentes, se reemplace
 el score en vez de aparecer dos veces.
    llamar a inicio() en el momento adecuado
    rutina fin() para que termine el juego y despues te mande a /Home
...
\
  ...
  /*pamandarhome += "\
                <tr>\
                <td>" + AllScores[0].nombre.toString() + "\
                </td>\
                <td>" + AllScores[0].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[1].nombre.toString() + "\
                </td>\
                <td>" + AllScores[1].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[2].nombre.toString() + "\
                </td>\
                <td>" + AllScores[2].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[3].nombre.toString() + "\
                </td>\
                <td>" + AllScores[3].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[4].nombre.toString() + "\
                </td>\
                <td>" + AllScores[4].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[5].nombre.toString() + "\
                </td>\
                <td>" + AllScores[5].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[6].nombre.toString() + "\
                </td>\
                <td>" + AllScores[6].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[7].nombre.toString() + "\
                </td>\
                <td>" + AllScores[7].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[8].nombre.toString() + "\
                </td>\
                <td>" + AllScores[8].puntaje + "\
                </td>\
              </tr>\
              <tr>\
                <td>" + AllScores[9].nombre.toString() + "\
                </td>\
                <td>" + AllScores[9].puntaje + "\
                </td>\
              </tr>\*/
...
void handleHome() {//----------------------------------------------------------------------------------Manejo Home
  ...
  if (aaaa != "") {
    ...
    aaaa.toCharArray(NewScore.nombre, 8);
    inicio();
  }
